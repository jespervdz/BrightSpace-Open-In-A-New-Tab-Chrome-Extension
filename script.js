...
// Checks if the page has an iframe wrapped document that can be opened in a new tab
function pageHasDocument() {
  try {
    return document.getElementsByTagName('d2l-iframe-wrapper-for-react')[0].getAttribute('src') != null;
  } catch {
    return false;
  }
}
